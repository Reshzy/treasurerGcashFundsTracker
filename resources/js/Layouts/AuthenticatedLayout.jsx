                    ...
                    <div className="flex h-16 justify-between">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center rounded-md border border-transparent bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none dark:bg-slate-800 dark:text-slate-300 dark:hover:text-slate-100"
                                            >
                                                {user.name}
                        ...
                        <div className="-me-2 flex items-center gap-1 sm:hidden">
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 transition duration-150 ease-in-out hover:bg-gray-100 hover:text-gray-500 focus:bg-gray-100 focus:text-gray-500 focus:outline-none dark:hover:bg-slate-700 dark:hover:text-slate-300"
                            >
                                <svg
                                    className="h-6 w-6"
                                    stroke="currentColor"
